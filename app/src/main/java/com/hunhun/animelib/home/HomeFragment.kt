...
import com.hunhun.animelib.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun setDataAnime(animeList: List<Anime>?) {
        animeAdapter.setData(animeList)
    }

    override fun onDestroyView() {
        super.onDestroyView()
        binding.animeRV.adapter = null
        _binding = null
    }
}